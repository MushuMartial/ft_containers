...
/*   Updated: 2022/07/26 15:25:33 by tmartial         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	class tree
	{
		...
		public:
			...
			bool erase (const key_type& k)
			{
				...
				bool side = this->side(tmp); //false = right, true = left; right from parent
				if (side == false)
					std::cout << "parent->right " << std::endl;
				else
					std::cout << "parent->left " << std::endl;
				...
				if (!tmp->left || !tmp->right)  //erase single node
				{
					...
					{
						std::cout << "tmp = " << tmp->right->data->first << std::endl;
						if (!side)
						{
							tmp->left = tmp->parent;
