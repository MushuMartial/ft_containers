...
/*   Updated: 2022/07/28 14:21:40 by tmartial         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	struct node
	{
		...
		public:
			...
			node(const ft::pair<const Key, T>& val, const key_compare& comp = key_compare()) : parent(NULL), left(NULL), right(NULL), comp(comp)
			{
